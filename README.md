...
- Build date: 2016-03-28T20:30:00.541Z
...
```shell
gem install ./iron_titan-0.1.1.gem
```
...
*IronTitan::CoreApi* | [**jobs_get**](docs/CoreApi.md#jobs_get) | **GET** /jobs | Get next job.
...
*IronTitan::ImagesApi* | [**images_name_get**](docs/ImagesApi.md#images_name_get) | **GET** /images/{name} | Get image by name.
