...
- Build date: 2016-06-20T21:55:08.252Z
...
```shell
gem install ./iron_titan-0.3.10.gem
```
(for development, run `gem install --dev ./iron_titan-0.3.10.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'iron_titan', '~> 0.3.10'
